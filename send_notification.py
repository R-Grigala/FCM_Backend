...
def send_fcm(registration_ids, message_title, message_desc):
    fcm_api = "AAAA8ILaOzc:APA91bFRapskgwOn3YgPI--eXo63jJalU5rd8FJbDOu3b0O5r1SyqyHnDZnOtPgp4_tf5T50MwGT90s-Y_0ozVW5uuR6Df4D9aF1ucu4jjpjlBihZO-4YI9xMCzDWzHMVQrwq25huxkt"
    url = "https://fcm.googleapis.com/fcm/send"
...
send_fcm(registration_ids=registratin_ids, message_title='Send Notification From send_fcm', message_desc='Test Test')